export default [
    ...
    },
    {
     id : 16,
       ...
       benefits: 'Santan Gopal Puja also prevents miscarriage during pregnancy. - Improves your chances of having a child significantly. - Performing this yajna makes the lives of children more prosperous. - It also gives intelligence and wisdom to children.',
       howItHappens:'The ceremony is known as the Gath Bandhan, and performed by devotees to gain a happy married life and/ or an ideal life partner. Pandas chant shlokas as the devotees offer red threads, which are tied by the Bhandaris, people who climb to the top of the Baidyanath Temple on the Panchshul..',
       aboutDevta:'Bal Gopal Puja is a special Hindu ritual dedicated to the worship of Lord Krishna in his childhood form, often referred to as “Bal Gopal” or “Laddu Gopal.” In this form, Lord Krishna is depicted as an adorable infant, crawling or standing, holding a butterball or a flute.',
       afterPooja:'After bhog, make him lie down on the pillow and you can either sing Thakurji a lullaby or press his legs to help him sleep better. You can also leave his Padukas alongside his bed so that he can use them if he needs to in the middle of the night.',
       bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
    },
    {
     id : 17,
       ...
       benefits: 'Gathbandhan puja helps in increasing the bond between married couples. It increases peace and harmony between family members. It protects from serious diseases and benefits bachelors who are looking for their ideal life partner..',
       howItHappens:'The specific procedure is to arrange a puja altar with the Lords idol, satyanarayan pooja photo, a lit lamp, incense sticks, and flowers, recite aarti with the altar, offer prasad, food items, sweets, coconut, and complete it by distributing prasad to everyone',
       aboutDevta:' A Special Ritual. During the holy month of Shravan, hundreds of red threads are tied to connect the domes of the Baidyanath Dham Temple and the Maa Parvati temple. This ceremony is known as the Gath Bandhan and can be performed by devotees..',
       afterPooja:'After bhog, make him lie down on the pillow and you can either sing Thakurji a lullaby or press his legs to help him sleep better. You can also leave his Padukas alongside his bed so that he can use them if he needs to in the middle of the night.',
       bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
    },
    {
     id : 18,
       ...
       benefits: 'Santan Gopal Puja also prevents miscarriage during pregnancy. - Improves your chances of having a child significantly. - Performing this yajna makes the lives of children more prosperous. - It also gives intelligence and wisdom to children.',
       howItHappens:'Incense sticks and a lamp must be a part of your Gopal puja. Every Hindu performs it twice every day in the morning and evening. It will destroy negativity and spread positivity at your home. Another important note is that you must not leave Bal Gopal alone in the house.',
       aboutDevta:'he Satyanarayana Puja is a puja (religious ritual worship) dedicated to the Hindu god Vishnu, who is also known as Satyanarayana.',
       afterPooja:'After bhog, make him lie down on the pillow and you can either sing Thakurji a lullaby or press his legs to help him sleep better. You can also leave his Padukas alongside his bed so that he can use them if he needs to in the middle of the night.',
       bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
    },
    {
     id : 19,
       ...
       benefits: 'Revering the Guru by performing Puja for Lord Brihaspati on every Thursdays can fetch good results in career growth, business areas, and also in family life. Worshipping Lord Brihaspati not only improve the life standard of the married couples but also cultivates the seeds of wisdom & virtue into their children minds.',
       howItHappens:'To appease Lord Brihaspati or Jupiter people observe fast on Thursdays. Fast observed on Thursday gives the person power to improve his health and strengthen his financial condition. Prayers are offered by people to BrihaspatiMahadev after reading Kathaa in the evening which completes the fast.',
       aboutDevta:'Brihaspati appears in the Rigveda as a sage born from the first great light, the one who drove away darkness, is bright and pure, and carries a special bow whose string is of cosmic order (basis of dharma).',
       afterPooja:'After bhog, make him lie down on the pillow and you can either sing Thakurji a lullaby or press his legs to help him sleep better. You can also leave his Padukas alongside his bed so that he can use them if he needs to in the middle of the night.',
       bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
    },
    {
     id : 20,
       poojaName:"Nakshatra",
       benefits: 'Nakshatra shanthi homam is a perfect one for acquiring the endowments from god to achieve wellbeing, riches and success by determining complex issues. When to Perform Nakshatra Shanthi Homam? Individuals can perform Nakshatra shanthi homam on their birthday to achieve heights in life.',
       howItHappens:'The Nakshatra Shanti puja or Nakshatra puja is performed to nullify the bad effects of nakshatras prevailing at the time of a persons birth. The puja aims to finish the bad effects of the planets in their main periods ( Mahadasha) or sub-periods ( antardasha) and attain positive results from Lord Nakshatra.',
       aboutDevta:'Some nakshatras like Asvini, Jyestha, Magha, Revati, and mool are considered as Shanti nakshatras and require Shanti puja to be performed to obtain excellent results in life. Individuals who are born in these stars may have a bad phase in the first two years of their life',
       afterPooja:'After bhog, make him lie down on the pillow and you can either sing Thakurji a lullaby or press his legs to help him sleep better. You can also leave his Padukas alongside his bed so that he can use them if he needs to in the middle of the night.',
       bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
    },
    {
        id : 21,
          ...
          benefits: 'Performing Pitra Puja, Pitra Tarpan and Pind Daan during these days considered highly meritorious as it is believed that those who perform these activities they get rid of Pitru Dosha and by performing these religious activities their ancestors get relieved from the cycle of birth and death and they attain salvation.',
          howItHappens:'A pooja for lord Shiva, goddess Parvati, Lord Ganesha and other members of Shiva family is performed at first and they are offered items like flowers, fruits, sweets, milk, curd, honey, desi ghee, sugar and many other things and it is enchanted that they have completed the Pitra Dosh Nivarna Pooja in the prescribed',
          aboutDevta:'Pitra Dosh Puja is performed by a person born under the ninth house where Sun and Rahu combine. If someones ancestors have not attained peace due to religious rituals at the time of death then this Dosha develops in the horoscope of the person.',
          afterPooja:'After performing the Pitra dosh Puja, devotees often engage in various activities to conclude the ritual and carry forward the blessings received from Lord Surya.',
          bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
       },
    {
     id : 22,
       poojaName:"Manglik Pooja",
       benefits: 'Performing this puja may help remove obstacles in ones career path, leading to better job opportunities and career growth. Harmony in Relationships: For those who have already experienced discord in their relationships due to Manglik Dosh, the puja can serve as a means to restore harmony and peace within the marriage',
       howItHappens:'It is said in astrology that if Mars is in the 1st, 4th, 7th, 8th and 12th position in a persons horoscope, then the person is considered to be suffering from Manglik Dosha. Manglik dosha occurs due to the position of planet Mars. Talking about Mars, it is called the God of war and this planet remains unmarrieBal God.',
       aboutDevta:'ndividuals afflicted with Manglik Dosha should regularly worship Lord Hanuman on Tuesdays and Saturdays by reciting Hanuman Chalisa or Bajrang Baan. Offerings such as sindoor (vermilion), ghee (clarified butter), jaggery (unrefined sugar), and red flowers should be made to Lord Hanuman.',
       afterPooja:'Performing Mangal Dosh Nivaran Puja is one of the most effective remedies as it does not completely remove the mangal dosh from the horoscope. The Angarakha dosh puja will not eliminate the planets effects of Mars and mangal.',
       bookWithUs: 'Convenience, authenticity, and personalized guidance. Access to experienced priests and experts. Seamless access to authentic rituals. Ensures desired outcomes with personalized assistance.'
    }
